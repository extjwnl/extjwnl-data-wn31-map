...
public class DictionaryReadTester {
    ...
    protected final List<Long> verbOffsets = Collections.singletonList(wn31VerbOffset);

    protected final List<Long> nounOffsets = Collections.singletonList(wn31TankOffset);

    protected final List<Long> adjOffsets = Collections.singletonList(wn31BrightOffset);

    protected final List<Long> adjSOffsets = Collections.singletonList(wn31DissilientOffset);

    protected final List<Long> advOffsets = Collections.singletonList(wn31BrightAdvOffset);
    ...
    protected final List<String> adjLemmas = Collections.singletonList("bright");
    ...
    public void testSynsetIterator() throws JWNLException {
        ...
        Assert.assertTrue(s.getOffset() > 0);
